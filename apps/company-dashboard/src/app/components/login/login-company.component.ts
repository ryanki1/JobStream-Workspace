...
import { AuthCandidateService } from '@jobstream-workspace/shared-ui';
  ...
  template: `
    <div class="login-container">
      ...
      <div class="login-section">
        ...
        <button (click)="login()" class="login-btn">Mit Google anmelden</button>
      </div>
      } @else {
...
export class LoginCompanyComponent implements OnInit {
  ...
  public authService = inject(AuthCandidateService);
