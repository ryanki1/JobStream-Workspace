...
namespace JobStream.Api.Migrations
{
    ...
    [Migration("20251205201047_AddAuditLogTable")]
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("JobStream.Api.Models.AuditLog", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uuid");
            ...
            modelBuilder.Entity("JobStream.Api.Models.PasswordResetToken", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uuid");
            ...
            modelBuilder.Entity("JobStream.Api.Models.User", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uuid");
            ...
            modelBuilder.Entity("JobStream.Api.Models.PasswordResetToken", b =>
                {
                    b.HasOne("JobStream.Api.Models.User", "User")
                        .WithMany()
